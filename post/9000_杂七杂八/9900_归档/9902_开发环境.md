...
docker run \
-d \
--name=icqlchen-clickhouse \
-v /Users/icqlchen/workspace/docker/clickhouse/conf/config.xml:/etc/clickhouse-server/config.xml \
-v /Users/icqlchen/workspace/docker/clickhouse/conf/users.xml:/etc/clickhouse-server/users.xml \
-p 28123:8123 \
-p 29000:9000 \
--restart=no \
