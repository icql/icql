...
![特殊二叉树](../../../resource/cs_数据结构_树_满二叉树_完全二叉树.png)
...
![二分搜索树BST](../../../resource/cs_数据结构_树_二分搜索树.png)
...
[cs_数据结构_树_avl.java](../../../resource/cs_数据结构_树_avl.java)

#### （1）LL
![cs_数据结构_树_avl_ll](../../../resource/cs_数据结构_树_avl_ll_1.png)
![cs_数据结构_树_avl_ll](../../../resource/cs_数据结构_树_avl_ll_2.png)

#### （2）RR
![cs_数据结构_树_avl_rr](../../../resource/cs_数据结构_树_avl_rr_1.png)
![cs_数据结构_树_avl_rr](../../../resource/cs_数据结构_树_avl_rr_2.png)

#### （3）LR
![cs_数据结构_树_avl_lr](../../../resource/cs_数据结构_树_avl_lr_1.png)
![cs_数据结构_树_avl_lr](../../../resource/cs_数据结构_树_avl_lr_2.png)

#### （4）RL
![cs_数据结构_树_avl_rl](../../../resource/cs_数据结构_树_avl_rl_1.png)
![cs_数据结构_树_avl_rl](../../../resource/cs_数据结构_树_avl_rl_2.png)
...
![cs_数据结构_树_23树](../../../resource/cs_数据结构_树_23树.png)
...
![cs_数据结构_树_b树](../../../resource/cs_数据结构_树_b树.png)
...
![cs_数据结构_树_红黑树和23树_1](../../../resource/cs_数据结构_树_红黑树和23树_1.png)
![cs_数据结构_树_红黑树和23树_2](../../../resource/cs_数据结构_树_红黑树和23树_2.png)
![cs_数据结构_树_红黑树和23树_3](../../../resource/cs_数据结构_树_红黑树和23树_3.png)
...
[cs_数据结构_树_红黑树.java](../../../resource/cs_数据结构_树_红黑树.java)
