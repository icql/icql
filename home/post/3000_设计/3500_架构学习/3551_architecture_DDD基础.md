...
> 
>2）集中式三层架构
>面向过程+面向对象的设计方法，接入层+逻辑层+数据访问层
> 
>3）分布式微服务架构
>应用之间解耦，解决单体应用的扩展性和弹性伸缩能力

![软件架构演进](../../../resource/architecture_DDD基础_软件架构演进.png)
...
![微服务设计](../../../resource/architecture_DDD基础_微服务设计.png)
...
![实体和值对象](../../../resource/architecture_DDD基础_实体和值对象.png)
